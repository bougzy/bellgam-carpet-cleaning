      ...
      <div className="container-custom py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8">
          ...
          <div className="lg:col-span-2">
            ...
            <p className="text-gray-400 mb-4">{regionConfig.footerDescription}</p>
            ...
            <div className="space-y-2">
              ...
              >
                <Phone className="w-4 h-4" />
                <span className="text-sm">{regionConfig.phoneDisplay}</span>
              </a>
              <a
              ...
              >
                <Mail className="w-4 h-4" />
                <span className="text-sm">{regionConfig.email}</span>
              </a>
              <div className="flex items-start space-x-2 text-gray-300">
                <MapPin className="w-4 h-4 mt-0.5 flex-shrink-0" />
                <span className="text-sm">
                  {regionConfig.address.city}, {regionConfig.address.province}, {regionConfig.address.country}
                </span>
              </div>
            </div>
          </div>
          ...
          {/* Locations — region-specific */}
          <div>
            <h4 className="text-white font-semibold mb-4">
              Service Areas — {regionConfig.shortLabel}
            </h4>
            <ul className="space-y-2">
              {regionConfig.footerLocations.map((link) => (
                <li key={link.name}>
                  <Link
                    href={link.href}
                    className="text-sm text-gray-400 hover:text-primary-400 transition-colors"
