          ...
          >
            ...
            <div className="relative z-10">
              ...
              >
                ...
                <span className="text-xs text-indigo-300 font-medium">Serving {regionConfig.label}</span>
              </motion.div>
              ...
              <motion.p
                ...
                className="body-large text-gray-300 mb-8 max-w-2xl mx-auto"
              >
                Get your free, no-obligation quote today. Same-day service available across {regionConfig.label}!
              </motion.p>
