...
export function StatsSection() {
  ...
  const stats = [
    ...
    { label: regionConfig.statsLabel, value: 15, suffix: '+' },
      ...
      <div className="container-custom">
        <div className="text-center mb-12">
          ...
          <motion.h2
            ...
            className="heading-2 mb-4"
          >
            {regionConfig.statsSubheading.replace('2010', '')}
            ...
            <StaggerItem key={index}>
              <motion.div whileHover={{ scale: 1.05, y: -10 }} transition={{ duration: 0.3 }}>
                <Card hover className="h-full text-center relative overflow-hidden">
                  ...
                  <CardContent className="p-8 relative z-10">
                    <div className="text-5xl font-bold gradient-text mb-2 animate-gradient">
                      <AnimatedCounter to={stat.value} duration={2500} suffix={stat.suffix} />
                    </div>
