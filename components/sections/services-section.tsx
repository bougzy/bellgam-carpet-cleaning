...
// ============================================================
// 🖼️  SERVICE CARD IMAGES — mapped to your /public/images folder
// ============================================================
const serviceImages: Record<string, string> = {
  'carpet-steam-cleaning':    '/images/b.jpeg',
  'pet-stain-odor-removal':   '/images/bus.png',
  'pet-odor-removal':         '/images/bus.png',
  'upholstery-cleaning':      '/images/rug.png',
  'area-rug-cleaning':        '/images/rug.png',
  'stain-removal':            '/images/b.jpeg',
};

// Fallback if a slug has no match above
const defaultServiceImage = '/images/b.jpeg';
              ...
              <StaggerItem key={service.id}>
                <Link href={`/services/${service.slug}`}>
                  <Card hover className="h-full overflow-hidden">
                    ...
                    <CardHeader>
                      <CardTitle className="transition-all duration-300 group-hover:translate-x-1">
                        {service.title}
                      </CardTitle>
                    </CardHeader>
                    <CardContent>
