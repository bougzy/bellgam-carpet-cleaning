...
export const TESTIMONIALS = [
  {
    ...
    rating: 5,
    text: 'My dog had been using a bedroom corner for weeks. Bellgams treated the carpet and padding and I cannot detect any odour at all. Worth every penny.',
  },
  {
    id: 2,
    name: 'Connor MacPhail',
    location: 'Burnaby Heights, Burnaby, BC',
    rating: 5,
    text: 'Previous owners had a large dog. Bellgams did a full deep clean and the house finally smells like ours. Carpets look almost new.',
  },
  {
    id: 3,
    name: 'Derek Oliphant',
    ...
    rating: 5,
    text: 'Spilled red wine on my beige carpet. The stain is gone — completely. Not faded, actually gone. Will be calling for regular maintenance now.',
  },
] as const;
