...
export default function ReviewsPage() {
  ...
  const reviews = regionConfig.testimonials;
    ...
    <div>
      ...
      <section className="section-padding bg-gradient-bg-1">
        <div className="container-custom text-center">
          <div className="inline-flex items-center space-x-2 px-4 py-2 rounded-full glass-card mb-4">
            <Star className="w-4 h-4 text-yellow-400 fill-yellow-400" />
            <span className="text-sm text-gray-300">Customer Reviews — {regionConfig.flag} {regionConfig.label}</span>
          </div>
          <h1 className="heading-1 mb-6">
            What Our <span className="gradient-text">Customers Say</span>
          </h1>
          ...
          <p className="body-large text-gray-400 max-w-2xl mx-auto">
            Real reviews from {isBC ? 'British Columbia' : 'Toronto & the GTA'} customers who trust Bellgams
          </p>
        </div>
      </section>
